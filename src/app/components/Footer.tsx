    ...
    <div className='w-full bg-blueLight mt-10'>
      <Container>
        <div className='text-sm flex flex-col md:flex-row md:items-center gap-2 justify-between mb-2'>
          <p className='mb-2 text-gray-700'>©️ ORIGIN.Doc</p>
          ...
          <div className='flex items-center gap-4 text-gray-700'>
            ...
            href="" 
            target='_blank'
            className='text-xl hover:text-primeColor cursor-pointer duration-300'><FaGithub /></a>
            <a 
            href="" 
            target='_blank'
            className='text-xl hover:text-primeColor cursor-pointer duration-300'><FaFacebook /></a>
            <a 
            href="" 
            target='_blank'
            className='text-xl hover:text-primeColor cursor-pointer duration-300' ><FaYoutube /></a>
          </div>
        </div>
      </Container>
    </div>
